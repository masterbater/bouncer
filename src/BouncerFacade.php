...
/**
 * @method static \Silber\Bouncer\Conductors\GivesAbilities allow(\MongoDB\Laravel\Eloquent\Model|string $authority)
 * @method static \Silber\Bouncer\Conductors\GivesAbilities allowEveryone()
 * @method static \Silber\Bouncer\Conductors\RemovesAbilities disallow(\MongoDB\Laravel\Eloquent\Model|string $authority)
 * @method static \Silber\Bouncer\Conductors\RemovesAbilities disallowEveryone()
 * @method static \Silber\Bouncer\Conductors\GivesAbilities forbid(\MongoDB\Laravel\Eloquent\Model|string $authority)
 * @method static \Silber\Bouncer\Conductors\GivesAbilities forbidEveryone()
 * @method static \Silber\Bouncer\Conductors\RemovesAbilities unforbid(\MongoDB\Laravel\Eloquent\Model|string $authority)
 ...
 * @method static \Silber\Bouncer\Conductors\SyncsRolesAndAbilities sync(\MongoDB\Laravel\Eloquent\Model|string $authority)
 * @method static \Silber\Bouncer\Conductors\ChecksRoles is(\MongoDB\Laravel\Eloquent\Model $authority)
 ...
 * @method static self refresh(null|\MongoDB\Laravel\Eloquent\Model $authority = null)
 * @method static self refreshFor(\MongoDB\Laravel\Eloquent\Model $authority)
